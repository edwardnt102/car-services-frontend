...
@Component({
  selector: 'app-add-edit-subs',
  templateUrl: './add-edit-subs.component.html',
  styleUrls: ['./add-edit-subs.component.scss']
})
export class AddEditSubsComponent implements OnInit {
